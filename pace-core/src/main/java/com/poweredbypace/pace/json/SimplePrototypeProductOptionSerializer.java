...
public class SimplePrototypeProductOptionSerializer extends JsonSerializer<PrototypeProductOption> {
	...
	public void serialize(PrototypeProductOption value, JsonGenerator jgen,
		...
		//jgen.writeObjectField("productOptionType", value.getProductOptionType());
		//jgen.writeStringField("sortType", value.getSortType().name());
		jgen.writeEndObject();
	}
