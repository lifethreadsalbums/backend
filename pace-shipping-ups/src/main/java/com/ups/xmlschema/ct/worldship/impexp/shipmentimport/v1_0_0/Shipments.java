 ...
 *       &lt;sequence>
 *         &lt;element name="Shipment" type="{http://www.ups.com/XMLSchema/CT/WorldShip/ImpExp/ShipmentImport/v1_0_0}ShipmentModel" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Shipments {
    ...
    protected List<ShipmentModel> shipment;
    ...
    public List<ShipmentModel> getShipment() {
        if (shipment == null) {
            shipment = new ArrayList<ShipmentModel>();
        }
